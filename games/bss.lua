...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/electuz/kocmoc/main/library.lua"))()
getgenv().api = loadstring(game:HttpGet("https://raw.githubusercontent.com/electuz/kocmoc/main/api.lua"))()
local bssapi = loadstring(game:HttpGet("https://raw.githubusercontent.com/electuz/kocmoc/main/bssapi.lua"))()
...
for i,v in next, game:GetService("Workspace").FlowerZones:GetChildren() do 
    if v:FindFirstChild("ColorGroup") then 
        warn("get ColorGroup: "..v.Name..v:FindFirstChild("ColorGroup").Value) 
    else 
        warn("can't get ColorGroup: "..v.Name) 
    end 
end
local flowertable = {}
...
local function useConvertors()
    ...
    -- if GetItemListWithValue()["Micro Converter"] > 0 and string.find(kocmoc.vars.autouseMode,"Micro Converter") then
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/electuz/kocmoc/main/functions/premium/loadperks.lua"))()
...
--loadstring(game:HttpGet("https://raw.githubusercontent.com/electuz/kocmoc/main/functions/premium/loadperks.lua"))()("WindowLoad",Window)
...
local jptoggle = miscc:CreateToggle("Jump Power", nil, function(State) kocmoc.toggles.loopjump = State end) jptoggle:CreateKeybind("Q", function(Key) end)
...
farmsettings:CreateTextBox("Autofarming Walkspeed", "Default Value = 105", true, function(Value) kocmoc.vars.farmspeed = Value end)
...
aqs:CreateDropdown("3rd or Denied Quests", {'Bucko Bee', 'Brown Bear', 'Black Bear', 'Riley Bee', 'Polar Bear'}, function(Option) kocmoc.vars.trdprefer = Option end)
            ...
            if kocmoc.toggles.autodoquest and game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Menus.Children.Quests.Content:FindFirstChild("Frame") then
                for i,v in next, game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Menus.Children.Quests:GetDescendants() do
                    if v.Name == "Description" then
                        if (not string.match(v.Parent.Parent.TitleBar.Text, kocmoc.vars.trdprefer) and kocmoc.vars.npcprefer == "All Quests") or string.match(v.Parent.Parent.TitleBar.Text, kocmoc.vars.npcprefer) or string.match(v.Parent.Parent.TitleBar.Text, kocmoc.vars.tndprefer) and not string.find(v.Text, "Puffshroom") then
